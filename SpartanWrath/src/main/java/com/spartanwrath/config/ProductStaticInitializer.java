...
public class ProductStaticInitializer {
    ...
    public void initializeStaticProducts() {
        ...
        staticProducts.add(new Product("Casco", "Casco de proteccion para sparring", "../../images/casco.jepg", 10.00, 2, ""));
        ...
        staticProducts.add(new Product("Proteina", "Whey Protein facilita el proceso", "../images/proteina.jpg", 24.99, 2, ""));
